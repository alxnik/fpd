...
public:
	...
	static void ToStr( unsigned long v, char* buffer, int bufferSize );
...
public:
	...
	*/
	...
	/// Set the attribute to value.
	void SetAttribute( unsigned long value );
	/// Set the attribute to value.
...
public:
	...
	*/
	...
	/// Sets the named attribute to value.
	void SetAttribute( const char* name, unsigned long _value )		{ XMLAttribute* a = FindOrCreateAttribute( name ); a->SetAttribute( _value ); }
	/// Sets the named attribute to value.
	void SetAttribute( const char* name, unsigned long long _value )		{ XMLAttribute* a = FindOrCreateAttribute( name ); a->SetAttribute( _value ); }
	/// Sets the named attribute to value.
